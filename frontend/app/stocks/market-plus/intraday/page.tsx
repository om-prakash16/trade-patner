    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    <h1 className="text-3xl font-black text-white tracking-tight mb-2">Market Plus</h1>
                    <p className="text-slate-400">Advanced intraday signals, breakouts, and market movers.</p>
                </div>
