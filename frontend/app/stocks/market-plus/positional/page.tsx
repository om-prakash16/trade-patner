    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    <h1 className="text-3xl font-black text-slate-900 dark:text-white tracking-tight mb-2">Positional Scanners</h1>
                    <p className="text-slate-500 dark:text-slate-400">Multi-day breakout signals for swing and positional trading.</p>
                </div>
